      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.header}>
          ...
          <View style={styles.profileContainer}>
            <Image source={ProfilePic} style={styles.profileImage2} />
          </View>
        </View>
        ...
        <View style={styles.actionsSection}>
          <TouchableOpacity style={styles.actionButton}>
            <Image source={SendMoney} style={styles.profileImage} />
            <Text style={styles.actionButtonText}>Send It</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.actionButton}>
            <Image source={Withdraw} style={styles.profileImage} />
            <Text style={styles.actionButtonText}>Top Up</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.actionButton}>
            <Image source={Home} style={styles.profileImage} />
            <Text style={styles.actionButtonText}>Payments</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.actionButton}
            onPress={handleTransactionHistory}>
            <Image source={Exchange} style={styles.profileImage} />
            <Text style={styles.actionButtonText}>History</Text>
          </TouchableOpacity>
        </View>

        <TouchableOpacity style={styles.promoSection}>
          <Image source={Award} style={styles.awardImage} />
          <View style={styles.promoFlex}>
            <Text style={styles.promoTitle}>Upgrade to Premium Account</Text>
            <Text style={styles.promoSubtitle}>
              Get maximum service and more benefits!
            </Text>
          </View>
        </TouchableOpacity>
